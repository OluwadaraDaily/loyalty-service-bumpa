...
import { useDashboardData, useDashboardStats, usePurchaseProduct, useSimulateAchievement } from '@/hooks/api/use-dashboard-data';
            ...
            if (result.success) {
                ...
                if (result.newly_unlocked_achievements && result.newly_unlocked_achievements.length > 0) {
                    ...
                    setAchievementNotification({
                        ...
                        badges: badges.map((badge: { id: number; name: string; description: string; icon_url: string | null }) => ({
                            id: badge.id,
                            name: badge.name,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                ...
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome back, {dashboardData?.user.name}!</h1>
                ...
                {/* Current Badge */}
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-1">{dashboardData && <CurrentBadge user={dashboardData.user} />}</div>
